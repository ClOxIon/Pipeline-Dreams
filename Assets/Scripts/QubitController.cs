...
namespace PipelineDreams {
    public class QubitController : MonoBehaviour {
        ...
        void Update() {
            if (Input.GetKeyDown(KeyCode.Q)) { IdealQ = Quaternion.Euler(-45, 0, 0) * IdealQ; QubitController_OnPlayerRotation(Quaternion.identity); } else if (Input.GetKeyDown(KeyCode.W)) {
