...
namespace PipelineDreams {
    ...
    public class InstructionContainer : PDObjectContainerLimitedCapacity<Instruction> {
        ...
        public void UseInstructionByName(string name)
        {
            ...
            if (inst != null)
            {
                ...
                Holder.GetComponent<EntityAI>().EntityClock += inst.TimeCost.Value;
            }
            else
        ...
        public virtual void Init(TaskManager tm, Entity holder, CommandsContainer pC) {
            base.Init(tm, holder);
            TargetContainer = pC;
